...
//     try {
//         const availableProducts = await Product.findOne({ $and: [{ $or: [{ _id: req.body._id }, { id: req.body.id }] }, { deleted_at: null }] });
//         console.log(availableProducts);
...
const productController = {
    ...
    /**
     * to manage count of quantity with remaining count and sold out count.
    ...
    /**
     * to add more quantity of product into total_quantity field as well as remaining_quantity field.
